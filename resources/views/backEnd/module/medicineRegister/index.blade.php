            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    <tr >
                        ...
                        <th class="text-center">Лекарственная форма</th>
                        <th class="text-center">Дозировка</th>
                        <th class="text-center">Регистрационный статус</th>
                        <th class="text-center">Дата регистраций</th>
                        <th class="text-center">Пройзводитель</th>
                        <th class="text-center">Держатель регистрационнго удостовирения</th>
                        <th></th>
                    </tr>
                    <tbody>
