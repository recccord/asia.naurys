    ...
    <div class="padding">
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                            <div class="form-group row">
                                <label for="title_ru"
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.russianBox') !!}@endif
                                </label>
                                <div class="col-sm-10">
                                    {!! Form::text('title_ru',$Topics->title_ru, array('placeholder' => '','class' => 'form-control','id'=>'title_ru','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            </div>
                        @endif
                        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                            <div class="form-group row">
                                <label for="title_kz"
                                       class="col-sm-2 form-control-label">{!!  trans('backLang.topicName') !!}
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.kazakhBox') !!}@endif
                                </label>
                                <div class="col-sm-10">
                                    {!! Form::text('title_kz',$Topics->title_kz, array('placeholder' => '','class' => 'form-control','id'=>'title_kz','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            </div>
                        @endif
                        @if(Helper::GeneralWebmasterSettings("en_box_status"))
                            <div class="form-group row">
                                <label for="title_en"
                                       class="col-sm-2 form-control-label">{!!  trans('backLang.topicName') !!}
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.englishBox') !!}@endif
                                </label>
                                <div class="col-sm-10">
        ...
        onImageUpload: function(files, editor, welEditable) {
            sendFile(files[0], editor, welEditable,0);
                                ...
                                @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                    <div class="form-group row">
                                        <label for="details_kz"
                                               class="col-sm-2 form-control-label">{!!  trans('backLang.bannerDetails') !!}
                                            @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.kazakhBox') !!}@endif
                                        </label>
                                        <div class="col-sm-10">
                                            <div class="box p-a-xs">
                                                {!! Form::textarea('details_kz',$Topics->details_kz, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control summernote_kz', 'dir'=>trans('backLang.ltr'),'ui-options'=>'{height: 300,callbacks: {
        onImageUpload: function(files, editor, welEditable) {
            sendFile(files[0], editor, welEditable,0);
        }
    }}')) !!}
            ...
            sendFile(files[0], editor, welEditable,1);
                            ...
                            @else
                                @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea('details_ru',$Topics->details_ru, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'5')) !!}
                                        </div>
                                    </div>
                                @endif
                                @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::textarea('details_kz',$Topics->details_kz, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'5')) !!}
                                        </div>
                                    </div>
                                @endif
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                        ...
                        @if(count($WebmasterSection->customFields) >0)
                            ...
                            @foreach($WebmasterSection->customFields as $customField)
                                ...
                                if (Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status") && Helper::GeneralWebmasterSettings("kz_box_status")) {
                                    if ($customField->lang_code == "ru") {
                                        $cf_land_identifier = trans('backLang.russianBox');
                                    } if ($customField->lang_code == "en") {
                                        $cf_land_identifier = trans('backLang.englishBox');
                                    } if ($customField->lang_code == "kz") {
                                        $cf_land_identifier = trans('backLang.kazakhBox');
                                    }
                                }
                                ...
                                if (Helper::GeneralWebmasterSettings("kz_box_status") && $customField->lang_code == "kz") {
                                    $cf_land_active = true;
                                    $cf_land_dir = "ltr";
                                }
                            ...
                            @if (Session::has('fileST'))
                                @if (Session::get('fileST') == "create")
                                    ...
                                    <div>
                                        ...
                                        @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                            <div class="form-group row">
                                                <label for="file_title_ru"
                                                       class="col-sm-2 form-control-label">{!!  trans('backLang.topicName') !!}
                                                    @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.russianBox') !!}@endif
                                                </label>
                                                <div class="col-sm-10">
                                                    {!! Form::text('title_ru','', array('placeholder' => '','class' => 'form-control','id'=>'file_title_ru','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                                </div>
                                            </div>
                                        @endif
                                        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                            <div class="form-group row">
                                                <label for="file_title_kz"
                                                       class="col-sm-2 form-control-label">{!!  trans('backLang.topicName') !!}
                                                    @if(Helper::GeneralWebmasterSettings("kz_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.kazakhBox') !!}@endif
                                                </label>
                                                <div class="col-sm-10">
                                                    {!! Form::text('title_kz','', array('placeholder' => '','class' => 'form-control','id'=>'file_title_kz','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                                </div>
                                            </div>
                                        @endif
                                        @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                    ...
                                    <div>
                                        ...
                                        @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    {!! Form::text('title_ru',Session::get('AttachFile')->title_ru, array('placeholder' => '','class' => 'form-control','id'=>'file_title_ru','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                                </div>
                                            </div>
                                        @endif
                                        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    {!! Form::text('title_kz',Session::get('AttachFile')->title_kz, array('placeholder' => '','class' => 'form-control','id'=>'file_title_kz','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                                </div>
                                            </div>
                                        @endif
                                        @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                ...
                                @if(count($Topics->relatedTopics)>0)
                                    ...
                                    <div class="row">
                                        <table class="table table-striped  b-t">
                                            ...
                                            <tbody>
                                            <?php
                                            $title_var = "title_ru" . trans('backLang.boxCode');
                                            $title_var2 = "title_en" . trans('backLang.boxCodeOther');
                                            ?>
                                        ...
                                        <div class="col-sm-offset-2 col-sm-8">
                                            ...
                                            @endif
                                             @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        {!! Form::text('title_kz',Session::get('Map')->title_kz, array('placeholder' => '','class' => 'form-control','id'=>'title_kz', 'dir'=>trans('backLang.ltr'))) !!}
                                                    </div>
                                                </div>
                                            @endif
                                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                            ...
                                            @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        {!! Form::textarea('details_kz',Session::get('Map')->details_kz, array('placeholder' => '','class' => 'form-control','id'=>'details_kz','rows'=>'3', 'dir'=>trans('backLang.ltr'))) !!}
                                                    </div>
                                                </div>
                                            @endif
                                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                                        ...
                                                        <div>
                                                            ...
                                                            @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::text('title_ru','', array('placeholder' => '','class' => 'form-control','id'=>'title_ru', 'dir'=>trans('backLang.ltr'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::text('title_kz','', array('placeholder' => '','class' => 'form-control','id'=>'title_kz', 'dir'=>trans('backLang.ltr'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                                            ...
                                                            @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::textarea('details_ru','', array('placeholder' => '','class' => 'form-control','id'=>'details_ru','rows'=>'3', 'dir'=>trans('backLang.ltr'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            ...
                                                            @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        {!! Form::textarea('details_kz','', array('placeholder' => '','class' => 'form-control','id'=>'details_kz','rows'=>'3', 'dir'=>trans('backLang.ltr'))) !!}
                                                                    </div>
                                                                </div>
                                                            @endif
                        ...
                        <div class="box-body">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status"))
                                                    <small>{!!  trans('backLang.russianBox') !!}</small> @endif
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group">
                                            <div>
                                                <small>{!!  trans('backLang.topicSEOTitle') !!}</small>
                                                @if(Helper::GeneralWebmasterSettings("kz_box_status") && Helper::GeneralWebmasterSettings("en_box_status"))
                                                    <small>{!!  trans('backLang.kazakhBox') !!}</small> @endif

                                                {!! Form::text('seo_title_kz',$Topics->seo_title_kz, array('class' => 'form-control','id'=>'seo_title_kz','maxlength'=>'65', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_url_slug_kz',$Topics->seo_url_slug_kz, array('class' => 'form-control','id'=>'seo_url_slug_kz', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_description_kz',$Topics->seo_description_kz, array('class' => 'form-control','id'=>'seo_description_kz','maxlength'=>'165', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_keywords_kz',$Topics->seo_keywords_kz, array('class' => 'form-control','id'=>'seo_keywords_kz', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <?php
                                        $seo_example_title = $Topics->title_kz;
                                        $seo_example_desc = Helper::GeneralSiteSettings("site_desc_kz");
                                        if ($Topics->seo_title_kz != "") {
                                        $seo_example_title = $Topics->seo_title_kz;
                                        }
                                        if ($Topics->seo_description_kz != "") {
                                        $seo_example_desc = $Topics->seo_description_kz;
                                        }
                                        if ($Topics->seo_url_slug_kz != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                        $seo_example_url = url($Topics->seo_url_slug_kz);
                                        } else {
                                        $seo_example_url = route('FrontendTopic', ["section" => $Topics->webmasterSection->name, "id" => $Topics->id]);
                                        }
                                        ?>
                                        <div class="form-group">
                                            <div>
                                                ...
                                                &nbsp;
                                                <div class="search-example" dir="ltr">
                                                    <a id="title_in_engines_kz" href="{{ $seo_example_url }}"
                                                       target="_blank">{{ $seo_example_title }}</a>
                                                    <span id="url_in_engines_kz">{{ $seo_example_url }}</span>
                                                    <div id="desc_in_engines_kz">{{ $seo_example_desc }} ...</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
@section('footerInclude')
                ...
                google.maps.event.addListener(map, 'click', function (e) {
                    ...
                    geocoder.geocode({
                        ...
                        if (status == google.maps.GeocoderStatus.OK) {
                            if (results[0]) {
                                @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                $("#details_ru").val(results[0].formatted_address);
                                @endif
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
    ...
    <script>
        ...
        @if(Helper::GeneralWebmasterSettings("ru_box_status"))
        $("#seo_title_ru").on('keyup change', function () {
            if ($(this).val() != "") {
                $("#title_in_engines_ru").text($(this).val());
            } else {
                $("#title_in_engines_ru").text("<?php echo $Topics->title_ru; ?>");
            }
        });
        $("#seo_description_ru").on('keyup change', function () {
            if ($(this).val() != "") {
                $("#desc_in_engines_ru").text($(this).val());
            } else {
                $("#desc_in_engines_ru").text("<?php echo Helper::GeneralSiteSettings("site_desc_ru"); ?>");
            }
        });
        $("#seo_url_slug_ru").on('keyup change', function () {
            if ($(this).val() != "") {
                $("#url_in_engines_ru").text("<?php echo url(''); ?>/" + slugify($(this).val()));
            } else {
                $("#url_in_engines_ru").text("<?php echo route('FrontendTopic', ["section" => $Topics->webmasterSection->name, "id" => $Topics->id]); ?>");
            }
        });
        @endif

        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
        $("#seo_title_kz").on('keyup change', function () {
            if ($(this).val() != "") {
                $("#title_in_engines_kz").text($(this).val());
            } else {
                $("#title_in_engines_kz").text("<?php echo $Topics->title_kz; ?>");
            }
        });
        $("#seo_description_kz").on('keyup change', function () {
            if ($(this).val() != "") {
                $("#desc_in_engines_kz").text($(this).val());
            } else {
                $("#desc_in_engines_kz").text("<?php echo Helper::GeneralSiteSettings("site_desc_kz"); ?>");
            }
        });
        $("#seo_url_slug_kz").on('keyup change', function () {
            if ($(this).val() != "") {
                $("#url_in_engines_kz").text("<?php echo url(''); ?>/" + slugify($(this).val()));
            } else {
                $("#url_in_engines_kz").text("<?php echo route('FrontendTopic', ["section" => $Topics->webmasterSection->name, "id" => $Topics->id]); ?>");
            }
        });
        @endif
            ...
            $.ajax({
                ...
                success: function(url) {
                    ...
                    if(lang==1) {
                        ...
                        $('.summernote_ru').summernote("insertNode", image[0]);
                    }
                    else{
                        $('.summernote_kz').summernote("insertNode", image[0]);
                    }
                }
            });
        }
