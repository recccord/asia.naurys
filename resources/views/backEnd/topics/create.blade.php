            ...
            <div class="box-body">
                ...
                @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                    <div class="form-group row">
                        <label for="title_kz"
                               class="col-sm-2 form-control-label">{!!  trans('backLang.topicName') !!}
                            @if(Helper::GeneralWebmasterSettings("kz_box_status") && Helper::GeneralWebmasterSettings("kz_box_status")){!!  trans('backLang.kazakhBox') !!}@endif
                        </label>
                        <div class="col-sm-10">
                            {!! Form::text('title_kz','', array('placeholder' => '','class' => 'form-control','id'=>'title_kz','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                        </div>
                    </div>
                @endif
            ...
            sendFile(files[0], editor, welEditable,0);
                        ...
                        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="box p-a-xs">
                                        {!! Form::textarea('details_kz','<div dir=ltr><br></div>', array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control summernote_kz', 'dir'=>trans('backLang.ltr'),'ui-options'=>'{height: 300,callbacks: {
        onImageUpload: function(files, editor, welEditable) {
            sendFile(files[0], editor, welEditable,0);
        }
    }}')) !!}
                    ...
                    @else
                        ...
                        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::textarea('details_kz','', array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'5')) !!}
                                </div>
                            </div>
                        @endif
                        @if(Helper::GeneralWebmasterSettings("en_box_status"))
                ...
                @if(count($WebmasterSection->customFields) >0)
                    ...
                    @foreach($WebmasterSection->customFields as $customField)
                        ...
                        if (Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status")) {
                            ...
                            } elseif ($customField->lang_code == "kz") {
