            ...
            <div class="box-body">
                ...
                @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('title_kz',$Banners->title_kz, array('placeholder' => '','class' => 'form-control','id'=>'title_kz','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                        </div>
                    </div>
                @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Banners->file_ru!="")
                                        ...
                                        @endif
                                    @endif
                                    {!! Form::file($file1, array('class' => 'form-control','id'=>'file_ru','accept'=>$file_allow)) !!}
                                </div>
                            </div>
                        @endif
                        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Banners->file_kz!="")
                                        @if($WebmasterBanner->type==1)
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-4 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ URL::to('uploads/banners/'.$Banners->file_kz) }}"><img
                                                                    src="{{ URL::to('uploads/banners/'.$Banners->file_kz) }}"
                                                                    class="img-responsive">
                                                            {{ $Banners->file_kz }}
                                                        </a>
                                                    </div>
                                        ...
                                        @else
                                            <a target="_blank"
                                               href="{{ URL::to('uploads/banners/'.$Banners->file_kz) }}">{!!  $Banners->file_kz !!}</a>
                                        @endif
                                    @endif
                                    {!! Form::file($file2, array('class' => 'form-control','id'=>'file_kz','accept'=>$file_allow)) !!}
                                </div>
                            </div>
                        @endif
                        @if(Helper::GeneralWebmasterSettings("en_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Banners->file_en!="")
                                        ...
                                        @endif
                                    @endif
                                    {!! Form::file($file3, array('class' => 'form-control','id'=>'file_en','accept'=>$file_allow)) !!}
                                </div>
                            </div>
                        @endif
                ...
                @if($WebmasterBanner->desc_status)
                    ...
                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('details_kz',$Banners->details_kz, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'3')) !!}
                            </div>
                        </div>
                    @endif
                    @if(Helper::GeneralWebmasterSettings("en_box_status"))
