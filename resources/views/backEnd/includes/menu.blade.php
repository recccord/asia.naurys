                ...
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a>
                            ...
                            <span class="nav-text">{{ trans('backLang.Modules') }}</span>
                        </a>
                        <ul class="nav-sub">
                            <li class="active">
                                <a onclick="location.href='{{ route('medicinesRegisterIndex') }}'">
                                    <span class="nav-text">{{ trans('backLang.MedicinesRegisterModule') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('adminHome') }}" onclick="location.href='{{ route('adminHome') }}'">
                                    <span class="nav-text">s2</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('adminHome') }}" onclick="location.href='{{ route('adminHome') }}'">
                                    <span class="nav-text">s3</span>
                                </a>
                            </li>
                        </ul>
                    </li>
