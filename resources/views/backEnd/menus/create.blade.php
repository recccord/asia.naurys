            ...
            <div class="box-body">
                ...
                @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                    <div class="form-group row">
                        <label for="title_kz"
                               class="col-sm-2 form-control-label">{!!  trans('backLang.sectionTitle') !!}
                            @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status") && Helper::GeneralWebmasterSettings("kz_box_status")){!!  trans('backLang.kazakhBox') !!}@endif
                        </label>
                        <div class="col-sm-10">
                ...
                <div id="link_div" class="form-group row" style="display: none">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('link','', array('placeholder' => '','class' => 'form-control','id'=>'title_ru', 'dir'=>trans('backLang.ltr'))) !!}
                    </div>
                </div>
