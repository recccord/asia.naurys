            ...
            <div class="box-body">
                ...
                @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                    <div class="form-group row">
                        <label for="title_ru"
                            ...
                            @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status") && Helper::GeneralWebmasterSettings("kz_box_status")){!!  trans('backLang.russianBox') !!}@endif
                        </label>
                        <div class="col-sm-10">
                ...
                @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                    <div class="form-group row">
                        <label for="title_kz"
                               class="col-sm-2 form-control-label">{!!  trans('backLang.sectionTitle') !!}
                            @if(Helper::GeneralWebmasterSettings("kz_box_status") && Helper::GeneralWebmasterSettings("en_box_status") && Helper::GeneralWebmasterSettings("ru_box_status")){!!  trans('backLang.kazakhBox') !!}@endif
                        </label>
                        <div class="col-sm-10">
                            {!! Form::text('title_kz',$Menus->title_kz, array('placeholder' => '','class' => 'form-control','id'=>'title_kz','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                        </div>
                    </div>
                @endif
                ...
                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                    <div class="form-group row">
                        <label for="title_en"
                            ...
                            @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status") && Helper::GeneralWebmasterSettings("kz_box_status")){!!  trans('backLang.englishBox') !!}@endif
                        </label>
                        <div class="col-sm-10">
                ...
                <div id="link_div" class="form-group row" style="{{ ($Menus->type ==1)? "":"display: none" }}">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('link',$Menus->link, array('placeholder' => '','class' => 'form-control','id'=>'title_ru', 'dir'=>trans('backLang.ltr'))) !!}
                    </div>
                </div>
