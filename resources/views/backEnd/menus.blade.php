                                ...
                                <div class="input-group input-group-sm">
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                {!! Form::text('title_ru',$EditedMenu->title_ru, array('placeholder' => trans('backLang.menuTitle').strip_tags(trans('backLang.russianBox')),'class' => 'form-control','id'=>'title_ru','required'=>'')) !!}
                                            </div>
                                        </div>
                                    @endif
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                {!! Form::text('title_kz',$EditedMenu->title_kz, array('placeholder' => trans('backLang.menuTitle').strip_tags(trans('backLang.kazakhBox')),'class' => 'form-control','id'=>'title_kz','required'=>'')) !!}
                                            </div>
                                        </div>
                                    @endif
                            ...
                            @else
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                {!! Form::text('title_ru','', array('placeholder' => trans('backLang.menuTitle').strip_tags(trans('backLang.russianBox')),'class' => 'form-control','id'=>'title_ru','required'=>'')) !!}
                                            </div>
                                        </div>
                                    @endif
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                {!! Form::text('title_kz','', array('placeholder' => trans('backLang.menuTitle').strip_tags(trans('backLang.kazakhBox')),'class' => 'form-control','id'=>'title_kz','required'=>'')) !!}
                                            </div>
                                        </div>
                                    @endif
                                    @if(Helper::GeneralWebmasterSettings("en_box_status"))
