                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('site_title_kz',$Setting->site_title_kz, array('placeholder' => trans('backLang.websiteTitle'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            @endif
                            ...
                            @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('site_desc_kz',$Setting->site_desc_kz, array('placeholder' => trans('backLang.metaDescription'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                            ...
                            @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('site_keywords_kz',$Setting->site_keywords_kz, array('placeholder' => trans('backLang.metaKeywords'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_t1_kz',$Setting->contact_t1_kz, array('placeholder' => trans('backLang.contactAddress'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                            ...
                            @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                <div class="form-group">
                                    ...
                                    {!! Form::text('contact_t7_kz',$Setting->contact_t7_kz, array('placeholder' => trans('backLang.worksTime'),'class' => 'form-control', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            @endif
                            @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                <div class="form-group">
                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'styleTab') ? 'active' : '' }}" id="tab-5">
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group row">
                                @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                    <div class="col-sm-6">
                                        <label for="style_logo_ru">{!!  trans('backLang.siteLogo') !!} @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.russianBox') !!}@endif</label>
                                ...
                                @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                    <div class="col-sm-6">
                                        <label for="style_logo_kz">{!!  trans('backLang.siteLogo') !!} @if(Helper::GeneralWebmasterSettings("kz_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.kazakhBox') !!}@endif</label>
                                        @if($Setting->style_logo_kz!="")
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-12 box p-a-xs text-center">
                                                        <a target="_blank"
                                                           href="{{ URL::to('uploads/settings/'.$Setting->style_logo_kz) }}"><img
                                                                    src="{{ URL::to('uploads/settings/'.$Setting->style_logo_kz) }}"
                                                                    class="img-responsive" id="style_logo_kz_prv"
                                                                    style="width: auto;max-width: 260px;max-height: 60px">
                                                            <br>
                                                            <small>{{ $Setting->style_logo_kz }}</small>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        @endif
                                        {!! Form::file('style_logo_kz', array('class' => 'form-control','id'=>'style_logo_ru','accept'=>'image/*')) !!}
                                        <small>
                                            <i class="material-icons">&#xe8fd;</i>( 260x60 px ) -
                                            {!!  trans('backLang.imagesTypes') !!}
                                        </small>
                                ...
                                @if(Helper::GeneralWebmasterSettings("en_box_status"))
                                    <div class="col-sm-6">
                                        <label for="style_logo_en">{!!  trans('backLang.siteLogo') !!} @if(Helper::GeneralWebmasterSettings("ru_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.englishBox') !!}@endif</label>
...
@section('footerInclude')
    ...
    <script type="text/javascript">
        ...
        $("#style_logo_kz").change(function () {
            readURL(this, "style_logo_kz_prv");
        });
