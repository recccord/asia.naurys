                ...
                <div class="tab-content pos-rlt">
                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'languageSettingsTab') ? 'active' : '' }}"
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group">
                                <label>{{ trans('backLang.kazakhLanguageFields') }} : </label>
                                <div class="radio">
                                    <div>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('kz_box_status','1',$WebmasterSetting->kz_box_status ? true : false , array('id' => 'kz_box_status1','class'=>'has-value')) !!}
                                            <i class="dark-white"></i>
                                            {{ trans('backLang.active') }}
                                        </label>
                                    </div>
                                    <div style="margin-top: 5px;">
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('kz_box_status','0',$WebmasterSetting->kz_box_status ? false : true , array('id' => 'kz_box_status2','class'=>'has-value')) !!}
                                            <i class="dark-white"></i>
                                            {{ trans('backLang.notActive') }}
                                        </label>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    ...
                                    <div>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::checkbox('languages_kz_status','1',($WebmasterSetting->languages_kz_status == 1)? true : false , array('id' => 'languages_kz_status','class'=>'has-value')) !!}
                                            <i class="dark-white"></i>
                                            {!!  trans('backLang.kazakhBox') !!}
                                        </label>
                                    </div>
                                    <div style="margin-top: 5px;">
                                        <label class="ui-check ui-check-md">
                            ...
                            <div class="form-group m-t">
                                ...
                                <div>
                                    <select name="languages_by_default" class="form-control c-select">
                                        <option value="ru" {{ ($WebmasterSetting->languages_by_default=="ru")?"selected='selected'":"" }}>{{ strip_tags(trans('backLang.russianBox')) }}</option>
                                        <option value="kz" {{ ($WebmasterSetting->languages_by_default=="kz")?"selected='selected'":"" }}>{{ strip_tags(trans('backLang.kazakhBox')) }}</option>
                            ...
                            <div class="form-group m-t">
                                ...
                                <div>
                                    <select name="timezone" id="timezone" class="form-control c-select">
                                        ...
                                        <option value="Africa/Dru_es_Salaam">Africa, Dar es Salaam (GMT+03:00)</option>
