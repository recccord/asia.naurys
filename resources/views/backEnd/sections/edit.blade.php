                    ...
                    <div class="box-body">
                        ...
                        @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('title_ru',$Sections->title_ru, array('placeholder' => '','class' => 'form-control','id'=>'title_ru','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            </div>
                        @endif
                        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('title_kz',$Sections->title_kz, array('placeholder' => '','class' => 'form-control','id'=>'title_kz','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_title_ru',$Sections->seo_title_ru, array('class' => 'form-control','id'=>'seo_title_ru','maxlength'=>'65', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_url_slug_ru',$Sections->seo_url_slug_ru, array('class' => 'form-control','id'=>'seo_url_slug_ru', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_description_ru',$Sections->seo_description_ru, array('class' => 'form-control','id'=>'seo_description_ru','maxlength'=>'165', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_keywords_ru',$Sections->seo_keywords_ru, array('class' => 'form-control','id'=>'seo_keywords_ru', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ru_box_status"))
                                        <?php
                                        $seo_example_title = $Sections->title_ru;
                                        $seo_example_desc = Helper::GeneralSiteSettings("site_desc_ru");
                                        if ($Sections->seo_title_ru != "") {
                                            $seo_example_title = $Sections->seo_title_ru;
                                        }
                                        if ($Sections->seo_description_ru != "") {
                                            $seo_example_desc = $Sections->seo_description_ru;
                                        }
                                        if ($Sections->seo_url_slug_ru != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                            $seo_example_url = url($Sections->seo_url_slug_ru);
                                        } else {
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_title_kz',$Sections->seo_title_kz, array('class' => 'form-control','id'=>'seo_title_kz','maxlength'=>'65', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_url_slug_kz',$Sections->seo_url_slug_kz, array('class' => 'form-control','id'=>'seo_url_slug_kz', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group">
                                            <div>
                                                <small>{!!  trans('backLang.topicSEODesc') !!}</small>
                                                @if(Helper::GeneralWebmasterSettings("kz_box_status") && Helper::GeneralWebmasterSettings("ru_box_status"))
                                                    <small>{!!  trans('backLang.kazakhBox') !!}</small> @endif

                                                {!! Form::textarea('seo_description_kz',$Sections->seo_description_kz, array('class' => 'form-control','id'=>'seo_description_kz','maxlength'=>'165', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_keywords_kz',$Sections->seo_keywords_kz, array('class' => 'form-control','id'=>'seo_keywords_kz', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("kz_box_status"))
                                        <?php
                                        $seo_example_title = $Sections->title_kz;
                                        $seo_example_desc = Helper::GeneralSiteSettings("site_desc_kz");
                                        if ($Sections->seo_title_kz != "") {
                                            $seo_example_title = $Sections->seo_title_kz;
                                        }
                                        if ($Sections->seo_description_kz != "") {
                                            $seo_example_desc = $Sections->seo_description_kz;
                                        }
                                        if ($Sections->seo_url_slug_kz != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                            $seo_example_url = url($Sections->seo_url_slug_kz);
                                        } else {
                                            $seo_example_url = route('FrontendTopicsByCat', ["section" => $Sections->webmasterSection->name, "cat" => $Sections->id]);
                                        }
                                        ?>
    ...
    <script>
        ...
        $("#seo_title_ru").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_ru").text("<?php echo $Sections->title_ru; ?>");
            }
        });
        ...
        $("#seo_url_slug_ru").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#url_in_engines_ru").text("<?php echo route('FrontendTopicsByCat', ["section" => $Sections->webmasterSection->name, "cat" => $Sections->id]); ?>");
            }
        });
        @endif
        @if(Helper::GeneralWebmasterSettings("kz_box_status"))
        $("#seo_title_kz").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_kz").text("<?php echo $Sections->title_kz; ?>");
            }
        });
        ...
        $("#seo_url_slug_kz").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#url_in_engines_kz").text("<?php echo route('FrontendTopicsByCat', ["section" => $Sections->webmasterSection->name, "cat" => $Sections->id]); ?>");
            }
        });
        @endif
        @if(Helper::GeneralWebmasterSettings("en_box_status"))
