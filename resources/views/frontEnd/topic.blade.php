...
@section('content')
    ...
    ?>
    <section id="inner-headline" style="background: url('{{ URL::to('uploads/topics/'.$Topic->photo_file) }}') center center no-repeat">
        <div class="container">
            <div class="row">
                <div id="smart__page__title">
    ...
    <section id="content">
        <div class="container">
            <div class="row">
                <div class="col-lg-{{(count($Categories)>0)? "8":"8 col-lg-offset-2"}}">
                            ...
                            <div id="comments">
                                @if(count($Topic->approvedComments)>0)
                                    ...
                                    @foreach($Topic->approvedComments as $comment)
                                        <?php
                                        $dtformated = date('d M Y, H:i:s', strtotime($comment->date));
                                        ?>
                                        <div class="row">
                                            <div class="col-lg-12">
