...
@section('content')
    ...
    <section id="inner-headline">
        <div class="container">
            <div class="row">
                <div id="smart__page__title" class="col-lg-12">
                    <div class="post-heading text-center">
                        <h1>{!! trans('backLang.'.$WebmasterSection->name) !!}</h1>
                                ...
                                @foreach($Topics as $Topic)
                                    ...
                                    <div class="col-lg-{{(count($Categories)>0)? "12":"6"}}">
                                        ...
                                        <article>
                                            ...
                                            <p class="topics-box">{{ str_limit(strip_tags($Topic->$details), $limit = 350, $end = '...') }}</p>
                                            <div class="bottom-article">
                                                <ul class="meta-post">
                                                    ...
                                                    @endif
                                                    <li class="visible-lg"><i class="fa fa-eye"></i> <a>{{ trans('frontLang.visits') }}
                                                            : {!! $Topic->visits !!}</a></li>
                                                    @if($Topic->webmasterSection->comments_status)
                                                        <li class="visible-lg"><i class="fa fa-comments"></i><a
