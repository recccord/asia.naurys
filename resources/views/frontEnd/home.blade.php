...
@section('content')
    ...
    @if(count($TextBanners)>0)
        ...
        ?>
        <section id="smart__home__featured" class="content-row-no-bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
    ...
    @if(count($HomeTopics)>0)
        <section id="smart__home__topics" class="content-row-bg">
            <div class="container">
                                ...
                                <div class="col-lg-4">
                                    @if($HomeTopic->photo_file !="")
                                        <img src="{{ URL::to('uploads/topics/'.$HomeTopic->photo_file) }}"
                                             alt="{{ $title }}"/>
                                    @endif
                                    <h3><a href="{{ $topic_link_url }}">
                                        @if($HomeTopic->icon !="")
                                            <i class="fa {!! $HomeTopic->icon !!} "></i>&nbsp;
                                        @endif
                                        {{ str_limit(strip_tags($title), $limit = 45, $end = '...') }}</a>
                                    </h3>
                                    ...
                                    <p class="text-left">{{ str_limit(strip_tags($HomeTopic->$details), $limit = 125, $end = '...') }}
                                    </p>
    ...
    @endif
       <section id="smart__home__qLinks" class="content-row-no-bg top-line">
           <div class="container">
               <div class="row">
                   <div style="float: left;">
    <div class="blokleft col-sm-4 col-xs-12" style="">
        <div class="image-box box1">
            <a href="http://pharmacy.consultingasia.kz/" class="image-hover-effect"> <img src="{{ URL::to('uploads/topics/q1.png') }}" class="img-responsive" alt="image-banner"><span>{{ trans('frontLang.q1') }}</span> </a>
        </div>
    </div>
    <div class="blok23 col-sm-8 col-xs-12">
        <div class="image-box zatem">
            <a href="sitePages/topic/4" class="image-hover-effect"> <img src="{{ URL::to('uploads/topics/q2.png') }}" class="img-responsive" alt="image-banner"><span>{{ trans('frontLang.q2') }}</span></a>
        </div>
        <div class="image-box zatem">
            <a href="sitePages/topic/3" class=""> <img src="{{ URL::to('uploads/topics/q3.png') }}" class="img-responsive" alt="image-banner"><span>{{ trans('frontLang.q3') }}</span></a>
        </div>
    </div>
</div>
               </div>
    ...
    @if(count($HomePhotos)>0)
        <section id="smart__home__gallery" class="content-row-no-bg">
            <div class="container">
                                ...
                                <ul id="thumbs" class="portfolio">
                                    ...
                                    @foreach($HomePhotos as $HomePhoto)
                                        ...
                                        @foreach($HomePhoto->photos as $photo)
                                            @if($ph_count<6)
                                                <li class="col-xs-6 col-sm-4 col-lg-2 design" data-id="id-0" data-type="web">
                                                    <div class="relative">
    ...
    @if(count($HomePartners)>0)
        <section id="smart__home__clients" class="content-row-no-bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="home-row-head">
