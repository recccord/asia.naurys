...
Route::Group(['prefix' => env('BACKEND_PATH'), 'middleware' => ['auth']], function () {
    ...
    Route::get('/send', 'HomeController@index');
    //Search
    ...
    //Module
    Route::get('/module/medicines-register/index','Module\MedicineRegisterController@index')->name('medicinesRegisterIndex');
    Route::get('/module/medicines-register/create','Module\MedicineRegisterController@create')->name('medicinesRegisterCreate');
    Route::post('/module/medicines-register/create','Module\MedicineRegisterController@createPost')->name('medicinesRegisterCreatePost');
    Route::get('/module/medicines-register/update/{id?}','Module\MedicineRegisterController@update')->name('medicinesRegisterUpdate');
    Route::get('/module/medicines-register/view/{id?}','Module\MedicineRegisterController@view')->name('medicinesRegisterView');
    Route::delete('/module/medicines-register/delete/{id?}','Module\MedicineRegisterController@delete')->name('medicinesRegisterDelete');
    Route::get('/module/medicines-register/export', 'Module\MedicineRegisterController@export')->name('medicinesRegisterExport');
