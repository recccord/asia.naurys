...
class TopicsController extends Controller
{
    ...
    public function store(Request $request, $webmasterId)
    {
        ...
        if (!empty($WebmasterSection)) {
            ...
            $Topic->title_kz = $request->title_kz;
            $Topic->title_en = $request->title_en;

            $Topic->details_ru = $request->details_ru;
            $Topic->details_kz = $request->details_kz;
            ...
            $Topic->seo_title_kz = $request->title_kz;
            $Topic->seo_title_en = $request->title_en;

            // URL Slugs
            $slugs = Helper::URLSlug($request->title_ru, $request->title_kz, $request->title_en, "topic", 0);
            $Topic->seo_url_slug_ru = $slugs['slug_ru'];
            $Topic->seo_url_slug_kz = $slugs['slug_kz'];
            ...
            $Topic->seo_description_kz = mb_substr(strip_tags(stripslashes($request->details_kz)), 0, 165, 'UTF-8');
    ...
    function seo(Request $request, $webmasterId, $id)
    {
        ...
        if (!empty($WebmasterSection)) {
            ...
            if (!empty($Topic)) {
                ...
                $Topic->seo_title_kz = $request->seo_title_kz;
                $Topic->seo_title_en = $request->seo_title_en;
                $Topic->seo_description_ru = $request->seo_description_ru;
                $Topic->seo_description_kz = $request->seo_description_kz;
                $Topic->seo_description_en = $request->seo_description_en;
                $Topic->seo_keywords_ru = $request->seo_keywords_ru;
                $Topic->seo_keywords_kz = $request->seo_keywords_kz;
                $Topic->seo_keywords_en = $request->seo_keywords_en;
                $Topic->updated_by = Auth::user()->id;

                //URL Slugs
                $slugs = Helper::URLSlug($request->seo_url_slug_ru, $request->seo_url_slug_kz, $request->seo_url_slug_en, "topic", $id);
                $Topic->seo_url_slug_ru = $slugs['slug_ru'];
                $Topic->seo_url_slug_kz = $slugs['slug_kz'];
                $Topic->seo_url_slug_en = $slugs['slug_en'];
...
// Maps Functions
    ...
    function mapsStore(Request $request, $webmasterId, $id)
    {
        ...
        if (!empty($WebmasterSection)) {
            ...
            $Map->title_kz = $request->title_kz;
            $Map->title_en = $request->title_en;
            $Map->details_ru = $request->details_ru;
            $Map->details_kz = $request->details_kz;
    ...
    function filesStore(Request $request, $webmasterId, $id)
    {
        ...
        if (!empty($WebmasterSection)) {
            ...
            if ($fileFinalName != "") {
                ...
                $AttachFile->title_kz = $request->title_kz;
