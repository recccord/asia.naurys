    ...
    public function updateSiteInfo(Request $request)
    {
        ...
        if (!empty($Setting)) {
            ...
            $this->validate($request, [
                ...
                'style_logo_kz' => 'mimes:png,jpeg,jpg,gif|max:3000',
            ...
            $formFileNameKz = "style_logo_kz";
            $fileFinalNameKz = "";
            if ($request->$formFileNameKz != "") {
                
                if ($Setting->style_logo_kz != "") {
                    File::delete($this->getUploadPath() . $Setting->style_logo_kz);
                }

                $fileFinalNameKz = time() . rand(1111,
                        9999) . '.' . $request->file($formFileNameKz)->getClientOriginalExtension();
                $path = $this->getUploadPath();
                $request->file($formFileNameKz)->move($path, $fileFinalNameKz);
            }
            ...
            if ($fileFinalNameKz != "") {
                $Setting->style_logo_kz = $fileFinalNameKz;
            }
            if ($fileFinalName2 != "") {
            ...
            $Setting->contact_t1_kz = $request->contact_t1_kz;
            ...
            $Setting->contact_t7_kz = $request->contact_t7_kz;
