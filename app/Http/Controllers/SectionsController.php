...
class SectionsController extends Controller
{
    ...
    public function store(Request $request, $webmasterId)
    {
        ...
        $Section->title_kz = $request->title_kz;
        ...
        $Section->seo_title_kz = $request->title_kz;
        $Section->seo_title_en = $request->title_en;

        //URL Slugs
        $slugs = Helper::URLSlug($request->title_ru, $request->title_kz, $request->title_en, "category", 0);
        $Section->seo_url_slug_ru = $slugs['slug_ru'];
        $Section->seo_url_slug_kz = $slugs['slug_kz'];
    ...
    public function seo(Request $request, $webmasterId, $id)
    {
        ...
        if (!empty($Section)) {
            ...
            $Section->seo_title_kz = $request->seo_title_kz;
            $Section->seo_title_en = $request->seo_title_en;
            $Section->seo_description_ru = $request->seo_description_ru;
            $Section->seo_description_kz = $request->seo_description_kz;
            $Section->seo_description_en = $request->seo_description_en;
            $Section->seo_keywords_ru = $request->seo_keywords_ru;
            $Section->seo_keywords_kz = $request->seo_keywords_kz;
            $Section->seo_keywords_en = $request->seo_keywords_en;
            $Section->updated_by = Auth::user()->id;

            //URL Slugs
            $slugs = Helper::URLSlug($request->seo_url_slug_ru, $request->seo_url_slug_kz, $request->seo_url_slug_en, "category", $id);
            $Section->seo_url_slug_ru = $slugs['slug_ru'];
            $Section->seo_url_slug_kz = $slugs['slug_kz'];
            $Section->seo_url_slug_en = $slugs['slug_en'];
